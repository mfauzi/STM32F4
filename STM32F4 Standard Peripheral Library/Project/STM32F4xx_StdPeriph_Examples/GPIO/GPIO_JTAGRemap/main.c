/**
  ******************************************************************************
  * @file    GPIO/GPIO_JTAGRemap/main.c 
...
int main(void)
{
  ...
  /* Initialize LEDs and Key Button mounted on STM324xG-EVAL/STM32437I-EVAL boards */       
  STM_EVAL_LEDInit(LED1);
  STM_EVAL_LEDInit(LED2);
  STM_EVAL_PBInit(BUTTON_KEY, BUTTON_MODE_GPIO);

  /* Test if Key push-button on STM324xG-EVAL/STM32437I-EVAL boards is pressed */
