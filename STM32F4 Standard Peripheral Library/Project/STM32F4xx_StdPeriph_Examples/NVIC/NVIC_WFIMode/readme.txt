...
@par Example Description 
  ...
  STM32F40xx/STM32F41xx devices and USART1 for STM32F427x/STM32F437x devices) data 
  register to a predefined buffer "DST_Buffer", and to generate an interrupt at the 
  end of the transfer. The EVAL_COM1 (USART3/1) receives data from Hyperterminal.
