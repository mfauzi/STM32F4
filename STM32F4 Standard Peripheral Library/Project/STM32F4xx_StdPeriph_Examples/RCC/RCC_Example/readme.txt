...
@note On the STM324xG-EVAL/STM32437I-EVAL boards, to genertate the HSE failure 
      you can remove the HSE quartz from the socket.
...
@par Directory contents 
  ...
  - RCC/RCC_Example/main.h                Header for main.c module  
