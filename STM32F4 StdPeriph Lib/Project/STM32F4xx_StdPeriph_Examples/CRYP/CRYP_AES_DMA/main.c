...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
uint32_t AES128key[4]={0x2b7e1516, 0x28aed2a6, 0xabf71588, 0x09cf4f3c};
uint32_t PlainData[DATA_SIZE]={
              0x6bc1bee2, 0x2e409f96, 0xe93d7e11, 0x7393172a,  /* Block 1 */
              0xae2d8a57, 0x1e03ac9c, 0x9eb76fac, 0x45af8e51}; /* Block 2 */
uint32_t EncryptedData[DATA_SIZE];
uint32_t DecryptedData[DATA_SIZE];
