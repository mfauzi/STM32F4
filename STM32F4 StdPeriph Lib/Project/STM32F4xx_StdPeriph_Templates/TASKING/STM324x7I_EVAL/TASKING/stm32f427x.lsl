...
section_setup ::linear
{
                                            ...
                                            )
                {
			            ...
			            vector ( id = 98, optional, fill = "UART7_IRQHandler" );                 // UART7
                        vector ( id = 99, optional, fill = "UART8_IRQHandler" );                 // UART8
                        vector ( id = 100, optional, fill = "SPI4_IRQHandler" );                  // SPI4
                        vector ( id = 101, optional, fill = "SPI5_IRQHandler" );                  // SPI5
                        vector ( id = 102, optional, fill = "SPI6_IRQHandler" );                  // SPI6
                }
}
